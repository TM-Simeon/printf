...
{
	unsinged int num = va_arg(l, unsigned int);
 ...
 * in uppercase
 * @l: va_list arguments from _printf
 * @f: pointer to the struct that determines if a flag is
 * passed to _printf
 ...
 * @l: va_list arguments from _printf
 * @f: pointer tot he struct that determines if a flag is passed to _printf
 * Description: the function calls convert() which in turn converts the input
 * number into the correct base and returns it as a string
 * Return: the number of char printed
 */
